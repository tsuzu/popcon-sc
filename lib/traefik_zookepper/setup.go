...
// Initialize initializes configuration for traefik on zookeeper
...
func initialize(retry int32) error {
	...
	if err != nil {
		return errors.New("traefikZookeeper.NewClient() error:" + err.Error())
	}
	...
	if len(advertiseAddr) == 0 {
		...
		if err != nil {
			return errors.New("traefikZookeeper.DefaultIPAddress() error" + err.Error())
		}
