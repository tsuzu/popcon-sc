...
var HttpLog, JudgeLog, DBLog, MailLog, FSLog, DockerLog, GeneralLog func() *logrus.Entry
...
func InitLogger(writer io.Writer, isDebug bool) {
	...
	DockerLog = func() *logrus.Entry { return logrus.WithField("category", "docker") }
	GeneralLog = func() *logrus.Entry { return logrus.WithField("category", "general") }
}
